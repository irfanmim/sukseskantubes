...
AlokNode berhasil }
{ Menghasilkan pohon P yang kosong (Nil) jika AlokNode 
gagal } */
{
	*P = AlokNode(akar);
	if (*P != Nil) {
...
/* {Mengirimkan addrNode hasil AlokNode sebuah elemen X } 
{ Jika AlokNode berhasil, maka addrNode tidak nil, dan 
...
{ Melakukan DealokNode/pengembalian addrNode P  */
{
	free(P);
}
